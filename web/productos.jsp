    ...
    <body>
        ...
        <nav class="navbar d-none d-lg-grid position-fixed col-2 h-100" id="navbar">
            ...
            <ul class="navbar-links">
                ...
                <li>
                    <%if (perfil.equals("Admin")) {%><a class="active" href="ServletCRUDproductos?txtIdP=P001&btn=Buscar&op=consultaId">
        ...
        <section class="container_datos col-12 col-lg-10 offset-lg-2 h-100 px-3 px-lg-5">
            <form action="" class="container_datos-input_buscar pt-3 mb-2">
                <div class="col-12 form-floating position-relative">
                    <input
                        ...
                        />
                    <label for="floatingInput">Ingresa el id del producto</label>
            ...
            <div class="container_datos-forms">
                                ...
                                <div class="row px-3 g-1">
                                    ...
                                    <div class="col-6 form-floating">
                                        <select
                                            ...
                                            <option value="Art. Tocador">Art. Tocador</option>
                                    ...
                                    <div class="col-12 my-2 form-floating">
                                        <textarea
                                            ...
                                            style="height: 125px"
                                            aria-label="Sizing example input"
                                            aria-describedby="inputGroup-sizing"></textarea>
                                    ...
                                    <div class="col-6">
                                        <div class="input-group form-floating">
                                            ...
                                            <input 
                                                ...
                                                aria-label="Sizing example input" 
                                                aria-describedby="inputGroup-sizing"
                                                onkeyup="this.value = Precios(this.value)">
                ...
                <div class="container_datos-vista_detalles">
                    ...
                    <div class="container_datos-vista_detalles-vista">
                        <div class="row g-1">
                            <%
                                ArrayList<ProductoBeans> lista2
                                        = (ArrayList<ProductoBeans>) request.getAttribute("lista2");
                                for (int i = 0; i < lista2.size(); i++) {
                                    ProductoBeans emp = lista2.get(i);
                            %>
                            <div class="col-12 my-2 form-floating">
                                <input
                                    placeholder="Id producto"
                            ...
                            <div class="col-6 my-2 form-floating">
                                <textarea 
                                    ...
                                    style="height: 125px"
                                    aria-label="Sizing example input"
                                    aria-describedby="inputGroup-sizing"><%=emp.getDes()%></textarea>
                                <label for="floatingInput">Descripción</label>
                            </div>
                            <div class="col-6 my-2 h-100">
                                <span 
                                    class="input-group-text" 
                                    id="inputGroup-sizing-lg">Imagen
                                </span>
                                <center><img src="imagenes/<%=emp.getImg()%>" alt="" width="100" height="100"></center>
                            </div>
                ...
                <div class="container_datos-tabla_tabla overflow-auto">
                    <div class="table-reposible w-100">
                        <table class="table table-hover">
                            ...
                            <%
                                ArrayList<ProductoBeans> lista
                                        = (ArrayList<ProductoBeans>) request.getAttribute("lista");
                                for (int i = 0; i < lista.size(); i++) {
                                    ProductoBeans emp = lista.get(i);
                            %>
                            <tbody>
                                <tr>
                                    <td><%=emp.getIdP()%></td>
