    ...
    <body>
        ...
        <nav class="navbar d-none d-lg-grid position-fixed col-2 h-100" id="navbar">
            ...
            <ul class="navbar-links">
                ...
                <li><%if(perfil.equals("Admin")){%><a class="active" href="ServletCRUDempleados?txtIdU=A001&btn=Buscar&op=consultaId">
                                ...
                                <div class="row px-3 g-1">
                                    ...
                                    <div class="col-12 my-2 form-floating">
                                        <input
                                            ...
                                            aria-describedby="inputGroup-sizing"
                                            />
                                        <label for="floatingInput">Direción</label>
                                    </div>
                                    <div class="col-12 my-2 form-floating">
                                        <input
